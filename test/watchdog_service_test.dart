...
void main() {
  test(
    'syncCheckIn sends canonical watchdog timestamps and reports synced',
    () async {
      ...
      expect(body['p_subject_capability'], 'a' * 64);
  ...
  test(
    'transport/backend failure degrades without breaking a filing',
    () async {
